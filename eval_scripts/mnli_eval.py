...
train_df = pd.read_csv('mnli_train.csv')
test_df = pd.read_csv('mnli_test.csv')


def run_test(lm):
    model = ClassificationModel('distilbert', lm, num_labels=3, args={'overwrite_output_dir': True, 'fp16': False, 'num_train_epochs': 1, 'save_steps': -1})
